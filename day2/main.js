...
arrays.forEach(array => {
    ...
    for (let i = 1; i < array.length; i++) {
        if (goAsc) {
            if (array[i - 1] < array[i] && (array[i] - array[i - 1] >= 1 && array[i] - array[i - 1] <= 3)) {
                goAsc = true
            } else {
                goAsc = false
            }
        ...
        if (goDesc) {
            if (array[i - 1] > array[i] && (array[i - 1] - array[i] >= 1 && array[i - 1] - array[i] <= 3)) {
                goDesc = true
            } else {
                goDesc = false
            }
    ...
    // console.log('Asc', goAsc)
    // console.log('Desc', goDesc)
    // console.log('----------------------')
